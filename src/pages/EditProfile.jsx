...
<Container>
    ...
    <div className="flex-1 p-8 max-w-4xl ml-40">
        ...
        <div className="flex items-center gap-4 mb-8">
            <img
                src="https://imgs.search.brave.com/tTDTKEIrl-pmV-ktc5MsVaxhxaj5rhLUhY51EvD0y3k/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9tLmdl/dHR5d2FsbHBhcGVy/cy5jb20vd3AtY29u/dGVudC91cGxvYWRz/LzIwMjMvMTAvQ2Fy/dG9vbi1CYXRtYW4t/UGZwLVByb2ZpbGUu/anBn"
                alt="avatar"
                className="w-16 h-16 rounded-full object-cover border-2 border-[#54E6D4]"
            />
            <div>
